	...
	const renderDzikir = filteredDzikir.map((dzikir) => {
		return (
			<div key={dzikir.id}>
				<div
					name="card"
					className="bg-[#FFFAF5] py-12 px-9 md:px-16 rounded-[30px] shadow-tipis"
				>
					<div name={"primary-" + dzikir.id} className="">
						...
						<div className="mt-4 w-16 md:w-24 h-5 md:h-7 text-xs md:text-base bg-senja text-white flex justify-center items-center text-center rounded-md">
							{dzikir.dibaca}
						</div>
					</div>
